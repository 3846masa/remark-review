...
class ReVIEWCompiler {
    ...
    compile() {
        ...
        visit(node, 'yaml', (YAMLNode) => {
            try {
                this.options = lodash_1.defaultsDeep(jsYAML.safeLoad(YAMLNode.value) || {}, this.options);
                this.options.baseTemplate = this.options.baseTemplate
                    ? searchFile_1.default(this.options.baseTemplate, this.file.dirname)
                    : null;
                this.options.templatesDir = searchFile_1.default(this.options.templatesDir, this.file.dirname);
                return true;
            }
            catch (_e) {
