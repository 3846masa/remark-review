...
function attacher(options) {
    const mergedOpts = lodash_1.defaultsDeep(options, (this.data('settings') || { review: {} }).review);
    mergedOpts.baseTemplate = searchFile_1.default(mergedOpts.baseTemplate);
    mergedOpts.templatesDir = searchFile_1.default(mergedOpts.templatesDir);
    ReVIEWCompiler_1.default.defaultOptions = lodash_1.defaultsDeep(mergedOpts, ReVIEWCompiler_1.default.defaultOptions);
